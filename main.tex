...
\keywords{BCI, Brain - Computer Interface, Social Impact, Emotions}

\begin{abstract}
BCI technology is now catching up with science fiction. The acceptance among the public is growing. How will this change our world and what do we need to do to make the change safe and beneficial? While our emotions are part of human experience, they also present an exploitable vulnerability. For maximum benefit from BCI, new laws and guidelines will be required and the time for the debate is now.
\end{abstract}
